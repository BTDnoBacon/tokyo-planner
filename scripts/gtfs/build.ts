/**
 * TokyoGTFS → RAPTOR용 바이너리 시간표 빌드.
 *
 * 사용법: pnpm data:build  (입력: data/gtfs/extracted/, 출력: data/engine/tokyo-rail.bin)
 * 사전에 data/gtfs/rail.zip을 data/gtfs/extracted/에 풀어둘 것.
 */
